...
" }")
        ...
        self.label_scene.setGeometry(QtCore.QRect(470, 80, 71, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(13)
        font.setBold(True)
        ...
        self.lineEdit_lr = QtWidgets.QLineEdit(self.groupBox_regist)
        self.lineEdit_lr.setGeometry(QtCore.QRect(530, 80, 113, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(13)
        ...
        self.label_session.setGeometry(QtCore.QRect(290, 80, 71, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(13)
        font.setBold(True)
        ...
        self.lineEdit_session.setGeometry(QtCore.QRect(350, 80, 113, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(13)
        ...
        self.pushButton_continue = QtWidgets.QPushButton(self.groupBox_regist)
        self.pushButton_continue.setGeometry(QtCore.QRect(310, 190, 141, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(13)
        ...
        self.pushButton_continue.raise_()
...
" }")
    ...
    def retranslateUi(self, MAIN_WINDOW):
        ...
        self.lineEdit_NUM.setText(_translate("MAIN_WINDOW", "0"))
        self.lineEdit_ID.setText(_translate("MAIN_WINDOW", "0"))
        ...
        self.label_scene.setText(_translate("MAIN_WINDOW", "左右："))
        self.lineEdit_lr.setText(_translate("MAIN_WINDOW", "0"))
        self.lineEdit_gesture_type.setText(_translate("MAIN_WINDOW", "0"))
        self.label_gesture_type.setText(_translate("MAIN_WINDOW", "手势类别："))
        self.label_session.setText(_translate("MAIN_WINDOW", "时期："))
        self.lineEdit_session.setText(_translate("MAIN_WINDOW", "0"))
        ...
        self.pushButton_continue.setText(_translate("MAIN_WINDOW", "当前为连续注册"))
        ...
        # 获取项目根目录的绝对路径
        current_file = Path(__file__).resolve()  # UI.py的绝对路径
        project_root = current_file.parent.parent.parent  # 向上三级到项目根目录
        data_path = str(project_root / "data")  # 拼接data目录

        self.lineEdit_sample_save_path.setText(_translate("MAIN_WINDOW", data_path))
